...
class AtendimentosController
{
        ...
        public function criar(): void
    {
        ...
        $horario    = trim($_POST['horario_atendimento'] ?? ''); // <-- corrigido aqui
        ...
        try {
            $stmt = $this->pdo->prepare(
                ...
                VALUES (:pessoa_id, :tipo_atendimento, :usuario_id, :descricao, "aberto", :data_atendimento, :hora_atendimento)'
            );
            $stmt->bindValue(':pessoa_id',         $pessoaId, PDO::PARAM_INT);
            $stmt->bindValue(':tipo_atendimento',  $tipoId,   PDO::PARAM_INT);
